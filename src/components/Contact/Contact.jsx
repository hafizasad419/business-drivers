    ...
    return (
        <section className="">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-orange">Contact <span className='text-skyBlue'> Us</span></h2>
                {showPopup ? (
                    <div className="fixed inset-0 flex justify-center items-center bg-gray-100 bg-opacity-75">
                        <div className="bg-white p-8 rounded-lg">
                            ...
                            <p className="text-center text-skyBlue mb-4 font-semibold">Your details have been successfully submitted. <br /> <span className='text-orange'>We'll get back to you soon.</span></p>
                    ...
                    <>
                        <p className="mb-8 lg:mb-16 text-center text-skyBlue font-semibold sm:text-xl">Don't Be Shy! Hit Us Up.</p>
                        <form onSubmit={handleFormSubmit} className="space-y-8">
                            ...
                            <div className="sm:col-span-2">
                                <label htmlFor="message" className="block mb-2 text-2xl font-bold text-orange">Your message</label>
                                <textarea
                                    id="message"
                                    name="message"
                                    rows="6"
