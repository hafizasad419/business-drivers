...
const PricingCard = ({ plans, title1, title2, }) => {
    return (
        <div className='my-8 md:my-16'>
            <h6 className='px-2 text-center text-orange md:text-4xl text-3xl font-bold'>
                {title1} <span className='text-skyBlue'> {title2}</span>
            </h6>
                        ...
                        <ul role="list" className="mb-8 space-y-4 text-left">
                            {plan.features.map((feature, index) => (
                                <li key={index} className="flex items-center space-x-3">
                                    ...
                                    <span className='text-orange font-bold'>{feature}</span>
                                </li>
                            ))}
                        </ul>
                        <div className="btn-container flex justify-center">
                            <NavLink to="/contact">
                                <Button
                                    ...
                                    className='md:block text-white px-6 font-bold bg-[#60c0e2] hover:bg-[#ffffff] hover:text-skyBlue border-[1.5px] border-[#60c0e2] duration-500'
                                />
                            </NavLink>
                        </div>
                    </div>
